class Arcots {
    constructor(year) {
        this.F = new Array(7).fill(0);
        this.V0U = new Array(7).fill(0);
        ...
        this.DV = new Array(7).fill(0);
        
        this.FH = new Array(7).fill(0);
        this.FHS = new Array(7).fill(0);
        this.FHSS = new Array(7).fill(0);
        this.VUG = new Array(7).fill(0);
...
Arcots.H = [26.8, 16.6, 4.6, 4.4, 19.0, 5.5, 6.2];
Arcots.G = [4.842, 4.955, 4.815, 4.752, 1.215, 1.079, 1.133];
Arcots.S = [
    0.50586805, 0.52359878, 0.49636692, 0.52503234, 0.26251617, 0.24335188, 0.26108261
];
